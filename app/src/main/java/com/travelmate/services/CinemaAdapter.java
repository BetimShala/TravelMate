...
public class CinemaAdapter extends ArrayAdapter<Cinema> {
    ...
    public CinemaAdapter(@NonNull Activity activity, int resource) {
        super(activity, R.layout.grid_cinema_layout);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View gridView = inflater.inflate(R.layout.grid_cinema_layout,null,false);
        ...
        Picasso.get().load(cinemas.get(position).getUrlImage()).resize(400,400).into(image);
